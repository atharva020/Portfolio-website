...
const NpmIcon = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden>
    <path d="M1.5 3h21v18H1.5V3zm4.05 15.75h3.15V9.45h3.15v9.3h3.15V6.75H5.55v12z" />
  </svg>
);
...
const SKILLS = [
  ...
  },
  {
    ...
    desc: "Feature scoping, repo management, and keeping a small eng team moving fast without stepping on each other.",
...
const PROJECTS = [
  ...
  {
    title: "DevTape",
    desc: "DevTape is a development-only browser debugging toolkit — a flight recorder for frontend failures. It builds a causal error timeline (click → fetch → response → console error → DOM context), redacts secrets, and exports shareable evidence for triage, bug reports, and AI-assisted diagnosis. Published on npm as atharva020.",
    tags: ["npm", "React", "Next.js", "Debugging", "TypeScript"],
    href: "https://www.npmjs.com/package/devtape-react",
    icon: Package,
  },
  {
    title: "SwiggyLens",
  ...
  },
  {
    ...
    desc: "Upload a call recording → get transcription, speaker diarisation, sentiment, and emotion breakdown.",
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            >
              ...
              {[
                ...
                {
                  href: "https://www.npmjs.com/~atharva020",
                  Icon: NpmIcon,
                  label: "npm",
                },
                {
          ...
          <div className="lg:col-span-2 flex flex-col justify-between gap-10">
            <div className="space-y-4">
              {[
                ...
                { href: "https://www.npmjs.com/~atharva020",        label: "npm",        sub: "npmjs.com/~atharva020", Icon: NpmIcon       },
